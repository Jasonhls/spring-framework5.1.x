...
final class JdkDynamicAopProxy implements AopProxy, InvocationHandler, Serializable {
	...
	public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
		...
		try {
			 ...
			 * 如果调用这个方法的class或接口与参数cls表示的类或接口相同，返回true，
			 * 或者是与参数cls表示的类或接口的父类相同，也返回true。
			 * 形象地：自身类.class.isAssignableFrom(自身类或子类.class)，返回true
			 * ArrayList.class.isAssignableFrom(Object.class)，为false
			 * Object.class.isAssignableFrom(ArrayList.class)，为true
			 */
			...
			if (chain.isEmpty()) {
				...
				/**
				 * invocation为上一步所创建的ReflectiveMethodInvocation对象，执行该对象的proceed()方法
				 * 该方法中会执行拦截器链
				 */
